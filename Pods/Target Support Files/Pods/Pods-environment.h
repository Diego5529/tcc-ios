...
#define COCOAPODS_VERSION_MINOR_Devise 1
...
#define COCOAPODS_VERSION_MAJOR_ngrvalidator 1
#define COCOAPODS_VERSION_MINOR_ngrvalidator 1
#define COCOAPODS_VERSION_PATCH_ngrvalidator 0
